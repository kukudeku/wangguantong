...
// 页面需要维护的四组列表数据和商品弹窗状态。
const members = ref([])
const availableItems = ref([])
const items = ref([])
const orders = ref([])
const itemVisible = ref(false)
// 分类同时用于查询下拉框和商品编辑下拉框，保持可选值一致。
const foodCategories = ['饮料', '餐食', '零食', '其他']

// 下单表单。会员使用 memberId，散客使用 customerName。
...
// 两个标签页各自拥有查询条件；itemForm 保存商品弹窗内容。
